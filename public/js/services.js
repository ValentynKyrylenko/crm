...
angular.module('crmApp')
    .constant("baseURL", "http://http://139.59.134.131/:3000/")
    ...
    .factory('commentFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
        ...
        return $resource(baseURL + "api/customers/:id/comments/:commentId", {id:"@Id", commentId: "@CommentId"}, {
            'update': {
                method: 'PUT'
            }
        });
    ...
    .factory('reportFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
        ...
        return $resource(baseURL + "api/reports/:id", {id:"@_id"}, {
            'update': {
                method: 'PUT'
            }
        });
    ...
    .factory('AuthFactory', ['$resource', '$http', '$localStorage', '$rootScope', '$window', 'baseURL', 'ngDialog', function($resource, $http, $localStorage, $rootScope, $window, baseURL, ngDialog){
        ...
        authFac.login = function(loginData) {
            ...
            $resource(baseURL + "api/users/login")
                .save(loginData,
                    function(response) {
        ...
        authFac.register = function(registerData) {
            ...
            $resource(baseURL + "api/users/register")
                .save(registerData,
                    function(response) {
